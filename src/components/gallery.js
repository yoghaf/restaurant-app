  ...
  <section id="list-resto">
      ...
      ${restos
        .map(
          ...
          <source max-width="600px" type="image/webp" srcset="${CONFIG.BASE_IMAGE_URL_SMALL}${resto.pictureId}">
         
          <source type="image/webp" srcset="${CONFIG.BASE_IMAGE_URL_LARGE}${resto.pictureId}">
        
         
                <img class="lazyload" src="${CONFIG.BASE_IMAGE_URL_LARGE}${resto.pictureId}" alt="${resto.name}" />
          </picture>
        </a>
