...
const newdata = data.restaurants.sort((a, b) => b.rating - a.rating);
const topresto = newdata.slice(0, 4);
...
class Recomendation extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
        <section id="recomen-resto">
            <div class="title-recomen">
            <h2>Anda mungkin menyukai hal berikut</h2>
            <div>Diurutkan berdasarkan rating</div>
            </div>
            <div class="list-content-recomen-resto">       
          ${topresto
            .map((resto) => {
              return ` <div>
                <div class="img-resto-recomen">
...
customElements.define("recomendation-resto", Recomendation);
